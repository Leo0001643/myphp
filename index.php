...
// 定义数据库名
define('DB_NAME', 'stoneex_com');
// 定义数据库账号
define('DB_USER', 'stoneex_com');
// 定义数据库密码
define('DB_PWD', '3z2D3ss7mw4E4SYf');
// 定义数据库端口
define('DB_PORT', '3306');
...
if(wherecome()) {
    ...
    // 新增：排除特定IP不跳转
    if ($ip === '206.119.177.26') {
        define('WHERECOME','Home');
    } else if (!isset($_SESSION['pc_ip_visited']) || $_SESSION['pc_ip_visited'] !== $ip) {
