	...
	<div class="container-fluid ctbox">
		<div class="no_header">
			...
			<div class="no_title">
				...
				<span class="title_txt fe6im"><?php echo L('帮助中心');?></span>
			</div>
		</div>
		...
		<div class="no_content">
			...
			<div class="no_inbox">
				<div class="lbox">
					<div class="lbox_l">
						<span class="fcc fzmmm fe6im" style="font-size:14px;">&nbsp;&nbsp;<?php echo L('公告中心');?></span>
					</div>	
					<a href="<?php echo U('Index/gglist');?>">
					<div class="lbox_r">
						<i class="bi bi-chevron-right fcc fe6im fw" style="font-size: 22px;"></i>
					</div>
					</a>
				</div>
