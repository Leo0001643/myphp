...
<!--    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.5.0/dist/css/bootstrap.min.css" integrity="sha384-9aIt2nRpC12Uk9gS9baDl411NQApFmC26EwAOH8WgZl5MYYxFfc+NcPb1dKGj7Sk" crossorigin="anonymous">-->
    <link rel="stylesheet" href="/Public/bendi/css/bootstrap-icons.css">
    ...
    <link rel="stylesheet" href="/Public/bendi/css/bootstrap1.min.css">
    <link rel="stylesheet" href="/Public/bendi/css/all.min.css">
        ...
        <div class="dela-presets-container-2" style="padding: 0px;">
            <div class="dela-preset-container">
                <form class="dela-preset-2-1" action="?" method="get" onclick="return false">
                    ...
                    <div class="fd-box">
                        <span class="fsl dfs"><?php echo L('登录');?></span>
                        <span class="fsr dfs" onclick="upreg()"><?php echo L('注册');?></span>
                    ...
                    <span class="dela-form__rorgot-password" onclick="forgot_password()">
                        <a href="<?php echo U('Login/findpwd');?>"><?php echo L('忘记密码');?>?</a></br>
...
<script src="/Public/bendi/js/jquery.min.js"></script>
