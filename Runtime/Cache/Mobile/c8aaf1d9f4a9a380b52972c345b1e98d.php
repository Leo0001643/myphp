...
<!--                    <p class="dela-form__title"><?php echo L('注册账号');?></p>-->
                    ...
                    <input type="text"  class="pml" id="invit" name="invite"  placeholder="Invite Code" required="" autocomplete="invite">
                        <div style="background: #212332;width: 100%;height: 44px;border-radius: 5px ;">
                            ...
                            <input type="submit" class="pml fl fbg" value="<?php echo L('提交');?>"  name="code" placeholder="Send"  class="send-btn"  required=""   style="width: 30%;border-radius: 0 5px 5px 0; text-align: center;background: #212332; border: none; color: #3db485;margin-bottom: 1.3em;border: 1px solid #212332;height: 23px;" >
                        </div>
