...
<!--					</div>-->
					...
					<div class="imgbox_5">
						<span class="fzmmm fe6im f12"><?php echo L('姓名');?></span>
					</div>
					<div class="zz_inputbox">
						<input type="text"  id="real_name" class="zz_input" value="<?php echo ($info["real_name"]); ?>"   placeholder="<?php echo L('请输入姓名');?>" <?php if($info["rzstatus"] == 2 || $info["rzstatus"] == 1): ?>disabled<?php endif; ?> />
					</div>
...
<script type="text/javascript">
    $("#sumbtn").click(function(){
        ...
        {'real_name' : real_name,'cardzm':cardzm,'cardfm':cardfm,'area':area,'rztype':rztype},
        function(data){
            if(data.code == 1){
                layer.msg(data.info);
