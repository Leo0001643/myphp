  ...
  <body>
	<div class="container-fluid " style="padding:0px;width:100vw;">
        ...
        <div class="allmoneybox">
            ...
            <div class="allmbox_2">
                <span class="fzmm fe6im" style="color: #fff"><?php echo L('账户总资产折合');?>(USDT)</span>
            ...
            <div class="allmbox_btn">
                <div class="allmbox_btn_1">
                    ...
                    <div class="allmbox_cbtn ">
                        ...
                        <span class="fe6im"><?php echo L('充币');?></span>
                    </div>
                    </a>
                    ...
                    <div class="allmbox_tbtn " >
                        ...
                        <span class="fe6im"><?php echo L('提币');?></span>
                    </div>
                    </a>
                    ...
                    <a href="https://buy.ramp.network/">
                        <div class="allmbox_tbtn " >
                            ...
                            <span class="fe6im"><?php echo L('买币');?></span>
                        </div>
                    </a>
        ...
        <div class="findbox">
            <div class="findbox_1">
                <div class="findbox_2">
                    <div class="findbox_3">
                        <span class="fzmm fe6im"><?php echo L('资产列表');?></span>
                    </div>
                </div>
            </div>
            
            <div class="mlistbox" id="moneylistbox">
                <?php if(is_array($list)): foreach($list as $key=>$vo): ?><a href="/User/coininfo?cid=<?php echo ($vo["id"]); ?>">
                    <div class="listbox">
                        ...
                        <div style="width:100%;height:60px;">
                            <div style="width:33.33%;height:60px;float:left;">
                                <div style="width:100%;height:30px;line-height:40px;">
                                    <span class="fcc"><?php echo L("可用");?></span>
                                </div>
                                <div style="width:100%;height:30px;line-height:20px;">
                                    <span class="fe6im f12" id="num_<?php echo ($vo["name"]); ?>">0.000000</span>
                                </div>
                            </div>
                            <div style="width:33.33%;height:60px;float:left;">
                                <div style="width:100%;height:30px;line-height:40px;">
                                    <span class="fcc"><?php echo L("冻结");?></span>
                                </div>
                                <div style="width:100%;height:30px;line-height:20px;">
                                    <span class="fe6im f12" id="numd_<?php echo ($vo["name"]); ?>">0.000000</span>
                                </div>
                            </div>
                            <div style="width:33.33%;height:60px;float:left;">
                                <div style="width:100%;height:30px;line-height:40px;text-align:right;">
                                    <span class="fcc"><?php echo L("折合");?>(USDT)</span>
                                </div>
                                <div style="width:100%;height:30px;line-height:20px;text-align:right;">
                                    <span class="fe6im f12" id="zhehe_<?php echo ($vo["name"]); ?>">0.000000</span>
                                </div>
                            </div>
                        </div>
                    </div>
	...
	<div class="dongbox" id="dongbox" style="display:none;">
	    <div class="dongbox_cbox">
	        ...
	        <div style="width:100%;;padding:5px 10px;">
	            <span class="fzmm fe6im"><?php echo L('由于资金统计存在延时，账户余额不一定是并非最新余额，如需准确余额请到相关账户页面进行查询');?></span>
	        </div>
	        <div class="showbtn" id="hidebtn">
	            <span class="fzmm fe6im"><?php echo L('确定');?></span>
	        </div>
	    </div>
