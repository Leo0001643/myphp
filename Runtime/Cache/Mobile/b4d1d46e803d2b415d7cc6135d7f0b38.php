	...
	<div class="container-fluid " style="padding:0px;width:100vw;">
		<div class="no_header">
            <div class="fl allhg txtl">
				<span class="fe6" style="font-size:20px;font-weight:bold;"><?php echo L('币币交易');?></span>
			</div>
		...
		<div class="content_title">
		    <div  class="content_title_l tleft">
		        ...
		        <span class="fe6" style="font-size:18px;font-weight:bold;" id="marketbox"><?php echo ($coinname); ?></span>
		        ...
		        <div class="tradebox_l">
		            ...
		            <div class="formbox" id="buycoinbox" style="display:block;">
		                ...
		                <div class="inputbox" style="background: #212332;display:none" id="sjbox">
		                    <div class="inputbox_float">
		                        <input type="text"  class="fcc xjinput" placeholder="<?php echo L('按市场最优价');?>"  />
		                    </div>
		                </div>
		...
		<div class="wtlistbox">
		    <div class="o_title_box fl">
		        <span class="fzmmm order_title fe6"><?php echo L('限价委托');?></span>
		    </div>
	    ...
	    <div class="dong_con">
	        <div style="width:100%;position:relative;z-index:9999999;top:0px;background: #212332">
	            <div class="dong_title">
	                <span class="dong_title_span fe6" style="font-weight: bold;"><?php echo L('全部');?></span>
	            </div>
