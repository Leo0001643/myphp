    ...
    <div class="card">
        <form class="card-form" onClick="return false">
            <div class="margin-topbox-px-10">
                <div data-bn-type="text" class="css-1g5tc38  tcl fch f36 fw"><?php echo L('立即注册');?><span class="floginbr"> <?php echo get_config('webname');?></span></div>
            ...
            <div class="input">
                ...
                <div class="action-button login-send-button tcc" style="background-color: rgba(255,255,255,0.5);width: 30%;line-height: 38px;">
                    <a><label class="" style="margin: 0px;color: #fff" ><?php echo L('获取验证码');?></label></a>
                </div>
            </div>
            <div class="action">
        ...
        <div class="login-reg tcr">
            ...
            <a href="<?php echo U('Login/index');?>"  class="css-utqtyo fbaseblue" ><?php echo L('登录');?></a>
        </div>
    </div>
</div>
<!-- partial -->
