                            ...
                            <div style="width:100%;height:600px;background:#fff;margin-bottom:20px;box-shadow: 0 2px 10px 0 rgb(0 0 0 / 10%);border-radius:5px;">
                                    ...
                                    <div style="width:50%;height:240px;float:left;padding:5px;">
                                        <div style="width:100%;height:240px;">
                                            <div style="width:100%;height:240px;padding:10px 0px 10px 10px;">
                                                ...
                                                <div style="width:100%;height:30px;">
                                                    <span class="f14 fcc"><?php echo L('单次最低');?> ：<?php echo ($info["ysnum"]); ?></span>
                                                </div>
                                                <div style="width:100%;height:30px;">
                                                    <span class="f14 fcc"><?php echo L('认购上限');?> ：<?php echo ($info["min"]); ?></span>
                                                </div>
                                                <div style="width:100%;min-height:30px;">
                                ...
                                <div style="width:100%;min-height:300px;margin-top:10px;padding:0px 20px;">
                                    ...
                                    <div style="width:100%;min-height:300px;border-bottom:1px solid #f5f5f5;">
                                        ...
                                        <?php if($uid <= 0): ?><div style="width:50%;height:50px;background:#f5f5f5;border-radius:5px;padding:0px 15px;">
				                        ...
				                        <?php if($uid <= 0): ?><div class="allbtn" onclick="gologin();" style="height:40px;line-height:50px;margin-top:5px;width:50%;cursor: pointer;line-height: 40px;
}">
				                            <span class="fzmm" style="color: #fff"><?php echo L('请先登陆');?></span>
				                        </div>
				                        <?php else: ?>
				                        <div class="allbtn" id="sumbtn" onclick="buyissue(<?php echo ($info["id"]); ?>)" style="height:50px;line-height:50px;margin-top:5px;width:50%;    cursor: pointer;line-height: 40px;
}">
				                            <span class="fzmm"style="color: #fff"><?php echo L('立即参与');?></span>
				                        </div><?php endif; ?>
