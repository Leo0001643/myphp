	...
	<div class="css-1tp5kus buy_coins">
				...
				<li  class="li-sub" style="list-style:none;">
					<a href="https://www.coinbase.com/">
						<div class="optionli">
							...
							<span class="f16"  style="color:#EAECEF;"> Coinbase</span>
						</div>
					</a>
				</li>
				<li  class="li-sub"  style="list-style:none;">
					<a href="https://www.kraken.com/">
						<div class="optionli">
							...
							<span class="f16"   style="color:#EAECEF;"> Kraken</span>
						</div>
					</a>
				</li>
				<li  class="li-sub"  style="list-style:none;">
					<a href="https://crypto.com/">
						<div class="optionli">
							...
							<span class="f16"   style="color:#EAECEF;"> Crypto</span>
						</div>
					</a>
				</li>
			</div>
	 ...
	 <div class="css-1tp5kus">
	     <a href="<?php echo U('Contract/index');?>" class="css-1smf7ma">
	         <div class="css-vurnku"><img src="/Public/Home/static/imgs/hot-2.svg" class="hot-2"><?php echo L('秒合约');?></div>
	     </a>
	 </div>
	 <div class="css-1tp5kus">
...
<script src="/Public/Home/js/jquery-2.0.js"></script>
<script>
$(function(){
  // 桌面端hover，移动端点击
  if(window.innerWidth > 800){
    $('.trad_coins').hover(
      function(){ $('.trad-sub').stop(true,true).slideDown(120); },
      function(){ $('.trad-sub').stop(true,true).slideUp(120); }
    );
  }else{
    $('.trad_coins > a').click(function(e){
      e.preventDefault();
      $('.trad-sub').slideToggle(120);
    });
  }
  // 防止点击下拉菜单时关闭
  $('.trad-sub').on('mouseenter',function(){ $(this).stop(true,true).show(); })
  .on('mouseleave',function(){ $(this).stop(true,true).slideUp(120); });
});
</script> 
	                                    ...
	                                    <div style="width:100%;top:0px;">
											...
											<a href="javascript:void(0)">
												<div class="sy_list_box">
													...
													<div class="sy_list_boxl  f14 fccs" style="text-align: center;" ><?php echo L('24小时量');?></div>
													<div class="sy_list_boxr  f14 fccs" ><?php echo L('涨幅');?></div>
												</div>
											</a>
                                ...
                                <div style="width:100%;height:50px;border-bottom:3px solid #151617;padding-right: 40%">
                                    <div class="klinetitle">
                                        <div class="klinetitle_l">
			                        	    <p class="newpricebox fw f12 fcgs"><?php echo ($coinname); ?></p>
			                        	    <p class="changebox fw f12 fcgs"><?php echo L('币币交易');?></p>
			                        	</div>
			                        	<div class="klinetitle_l">
														...
														<div class="formbox col-6 klinetitle-s-box klinetitle-s-box-l" id="buycoinbox">
															...
															<div style="width:100%;height:30px;margin-bottom:10px;">
																<div style="width:30%;height:30px;line-height:30px;float:left;">
																	<span class="f14 fcc"><?php echo L('可用');?></span>
																</div>
																<div style="width:70%;height:30px;line-height:30px;float:left;text-align:right;">
																	<?php if($uid <= 0): ?><span class="f14 fcc">- - </span>
																	<?php else: ?>
																	<span class="f14 fcc"><?php echo ($usdt_blance); ?></span><?php endif; ?>
															...
															<div class="formbox_op">
																<div class="formbox_op_list jy-btn-buy btn_bg_color fcc" id="buyxjbtn">
																	<span class="f12 btn_bg_color_tcg" id="xjspan" ><?php echo L('限价委托');?></span>
																</div>
																<div class="formbox_op_list jy-btn-buy" id="buysjbtn">
																	<span class="f12 btn_bg_color_tch" id="sjspan"><?php echo L('市价委托');?></span>
																</div>
															</div>
															...
															<div class="inputbox" style="background: #2c2d2e;display:none" id="sjbox">
																<div class="inputbox_float">
																	...
																	<input type="text"   class="fcc xjinput  sjxjinput" placeholder="<?php echo L('按市场最优价');?>" style="background:rgb(44, 45, 46);"  disabled="disabled"  />
																</div>
															</div>
														...
														<div class="formbox col-6 klinetitle-s-box" id="sellcoinbox">
															...
															<div style="width:100%;height:30px;margin-bottom:10px;">
																...
																<div style="width:70%;height:30px;line-height:30px;float:left;text-align:right;">
																	<?php if($uid <= 0): ?><span class="f14 fcc">- - </span>
																	<?php else: ?>
																		<span class="f14 fcc"><?php echo ($coin_blance); ?></span><?php endif; ?>
																	<span class="f14 fcc"><?php echo ($symbolup); ?></span>
																</div>
															</div>

															<div class="formbox_op">
																<div class="formbox_op_list jy-btn btn_bg_color" id="sell_xjbtn">
																	<span class="f12 btn_bg_color_tcg" id="sell_xjspan"><?php echo L('限价委托');?></span>
																</div>
																<div class="formbox_op_list jy-btn" id="sell_sjbtn">
																	<span class="f12 btn_bg_color_tch" id="sell_sjspan"><?php echo L('市价委托');?></span>
																</div>
															</div>
                                ...
                                <div style="width:100%;min-height:1009px;background:#1a1b1c;">
                                    <div style="width:100%;height:40px;padding:0px 15px;">
                                        <div style="min-width:20%;height:40px;line-height:40px;padding: 0px 5px;">
                                            <span class="f12 fccs"><?php echo L('盘口');?></span>
                                        </div>
                                            ...
                                            <div style="width:100%;">
		                                        <div style="width:100%;height:20px;padding:0px 5px;">
		                                            <div class="tradebox_title col-4 tcl">
		                                                <span class="fccs f12"><?php echo L('价格');?></span>
		                                            </div>
		                                            <div class="tradebox_title tcc col-4">
		                                                <span class="fccs f12"><?php echo L('数量');?></span>
		                                            </div>
													<div class="tradebox_title col-4 tcr">
														<span class="fccs f12"><?php echo L('时间');?></span>
													</div>
		                                        </div>
					...
					<div style="width:100%;float:left;min-height: 160px;border-top: 10px solid #151617;background: #fff">
						...
						<div class="order-main" style="background: #1a1b1c">
							<?php if($uid <= 0): ?><div class="table-history-more">
									...
									<p class="fccs"> <?php echo L('暂无订单');?></p>
								</div>
								<?php else: ?>
								<div class="table-box order-main-table-current" >
									<table class="table fcf order-main-table ">
										...
										<?php if(is_array($bblist1)): foreach($bblist1 as $key=>$vo): ?><tr class=" f12">
												...
												<?php if($vo["status"] == 1): ?><td class=" f14"><?php echo L('委托中');?></td>
													<?php elseif($vo["status"] == 2): ?>
													<td class=" f14"><?php echo L('交易完成');?></td>
													<?php elseif($vo["status"] == 3): ?>
													<td class=" f14"><?php echo L('已撤消');?></td><?php endif; ?>

												<?php if($vo["type"] == 1): ?><td class=" f14"><?php echo ($vo["usdtnum"]); ?></td>
													<?php elseif($vo["type"] == 2): ?>
													<td class=" f14"><?php echo ($vo["coinnum"]); ?></td><?php endif; ?>
									...
									<div class="table-history-more">
										<?php if(empty($bblist1)): ?><img src="/Public/Home/static/imgs/empty-dark.png" class="empty-svg" >
											<p class="fccs"> 暂无订单</p>
											<?php else: ?>
											<a href="<?php echo U('Contract/bborder');?>">
								...
								<div class="table-box order-main-table-history">
									...
									<table class="table fcf order-main-table ">
										...
										<tbody style="background: #151617">
										<?php if(is_array($bblist)): foreach($bblist as $key=>$vo): ?><tr class=" f12">
												...
												<div class="bcontentop" style="width:8%">
													<td class=" f14"><?php echo ($vo["symbol"]); ?></td>
												</div>
									...
									<?php if(empty($bblist)): ?><img src="/Public/Home/static/imgs/empty.e90e5075.svg" class="empty-svg" >
										<p class="fccs"> 暂无订单</p>
										<?php else: ?>
											<a href="<?php echo U('Contract/bbhistoryorder');?>">
											<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"viewBox="0 0 384 512"fill="#e6ecf2"><path d="M192 384c-8.188 0-16.38-3.125-22.62-9.375l-160-160c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0L192 306.8l137.4-137.4c12.5-12.5 32.75-12.5 45.25 0s12.5 32.75 0 45.25l-160 160C208.4 380.9 200.2 384 192 384z"/></svg>
											<span class="fcf"> 查看更多</span>
										</a><?php endif; ?>
								</div>
                ...
                if(data.code == 1){
                    ...
                    if(data.data == '' || data.data == null){
                        html = '<div style="width:100%;height:100px;line-height:100px;text-align:center;">'+ 
                               '<span class="f12 fcf">' + "<?php echo L('没有获取数据');?>" + '</span>'+
                               '</div>';
