...
<div id="main-content">
	...
	<div id="main" class="main">
		<div class="main-title-h">
			<span class="h1-title"><a href="<?php echo U('Article/index');?>">公告管理</a> >></span>
            <span class="h1-title"><?php if(empty($data)): ?>添加公告<?php else: ?>编辑公告<?php endif; ?></span>
		</div>
		<div class="tab-wrap">
			<div class="tab-content">
				<form id="form" action="<?php echo U('Article/ggeditup');?>" method="post" class="form-horizontal" enctype="multipart/form-data">
									...
									<td>
										<div id="addpicContainer">
											<?php if(!empty($data["img"])): ?><!--没有图片显示默认图片-->
												<img id="up_img" onclick="getElementById('inputfile').click()" style="cursor:pointer;max-width:100px;" title="点击添加图片" alt="点击添加图片" src="/Upload/article/<?php echo ($data["img"]); ?>">
												<?php else: ?>
												<!--没有图片显示默认图片-->
