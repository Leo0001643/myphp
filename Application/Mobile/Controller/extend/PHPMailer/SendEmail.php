...
class SendEmail1
{
    ...
    private static $From 		= 'Serviceokx@163.com'; //发送者的邮件地址
    private static $FromName 	= 'OKX'; //发送邮件的用户昵称
    private static $Username 	= 'Serviceokx@163.com'; //登录到邮箱的用户名
    private static $Password 	= 'FDHJUTQDJIZREXZJ'; //第三方登录的授权码，在邮箱里面设置
