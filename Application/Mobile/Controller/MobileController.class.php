...
class MobileController extends \Think\Controller
{
	...
	{
		$allow_controller=array("Ajax","Ajaxtrade","Api","Article","Chart","Finance","Index","Login","Pay","Queue","Trade","User","Issue",  "Morefind","Financing","Exchange","Orepool","Contract","Chat");
