...
// require '../extend/PHPMailer/SendEmail.php';
...
class LoginController extends MobileController
{
	...
	{
		parent::_initialize();	$allow_action=array("index","getcodesss","register","upregister","loginsubmit","loginout","findpwd","findpaypwd","webreg","loption","setlang","lhelp","sendcode","findsendcode","resetpwd",'registers',"sendMobileSms");
    ...
    public function resetpwd($email=null,$ecode=null,$lpwd=null){
		...
		if (checkstr($email) || checkstr($lpwd)) {
			$this->ajaxReturn(['code'=>0,'info'=>L('您输入的信息有误')]);
		}
		if($email == ''){
...
//		}
        ...
        if($_POST){
            ...
            if($type == 2){
                ...
                $message = '<div style="background: #1f253a; width: 100%; color: #93a1c2; padding: 20px"><div style="width: 60%; margin-left: 10%"><h2 style="color: #fff">Account Activation</h2>'
                    .'<div style="color: #93a1c2">Dear users, welcome to OKX,Your verification code is:</div>'
                    .'<div style="margin-top: 20px;height: 100px;background-color: #0f121d;width: 100%;color: #1373e8;font-size: 30px;line-height: 100px;text-align: center;font-weight: 600;">'
                    .$code
                    ."</div><h4>Security Tips:</h4><ol><li>Don't tell anyone your password and secondary verification code.</li>"
                    ."<li>Don't call any customer service person who claims to be OKX.</li></ol><h4>OKX Team</h4>"
    ...
    //                 .'<p>Thank you for choosing OKX</p>'
    //                 .'<p>If you have any questions and suggestions, please contact our customer service team</p>'
    //                 .'<p>Serviceokx@163.com</p>'
    //             ;
    //         }
    //         if($type == 2){
    //             $title = 'loginAccount Activation';
    //             $message = '<p>loginAccount Activation</p>'
    //                 .'<p>Dear users, welcome to OKX,Your verification code is:</p>'
    //                 .$code
    //                 .'<p>Security Tips:</p>'
    //                 ."<p>1.Don't tell anyone your password and secondary verification code.</p>"
    //                 ."<p>2.Don't call any customer service person who claims to be OKX.</p>"
    //                 .'<p>OKX Team</p>'
