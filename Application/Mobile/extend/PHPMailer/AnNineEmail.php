...
class AnNineEmail
{
    ...
    private static $From 		= '18718514521@163.com'; //发送者的邮件地址
    private static $FromName 	= 'an9'; //发送邮件的用户昵称
    private static $Username 	= '18718514521@163.com'; //登录到邮箱的用户名
    private static $Password 	= 'TGBMPCNQJECYZQIQ'; //第三方登录的授权码，在邮箱里面设置
