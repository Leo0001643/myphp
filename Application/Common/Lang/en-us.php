...
return [
    '禁止使用特殊符号当作密码' => 'Special symbols are not allowed as password',
    "建仓" => "buy",
    "正在结算中" => "Billing",
    "继续下单" => "continue",
	...
	"您的充值申请已确认，请注意查收" => "Your recharge application has been confirmed, please check it",
	"您的提币申请被驳回，请联系管理员" => "Your withdrawal application was rejected, please contact customer service",
    ...
    "最后登录" => "Last Login",
    "未登录" => "Not logged in",
    "你的交易量尚未完成无法申请提款，请完成后再来申请提款" => "Your trading volume is not completed and you cannot apply for withdrawal. Please complete it before applying for withdrawal",
    "限制已清除" => "Limit cleared",
    "该用户没有充值记录" => "This user has no recharge record",
    "增加额度必须大于0" => "Increase amount must be greater than 0",
    "已增加合约交易额度" => "Contract trading limit increased",
    "已创建充值记录并设置额度" => "Recharge record created and limit set",
    "减少额度必须大于0" => "Reduce amount must be greater than 0",
    "已减少合约交易额度" => "Contract trading limit reduced",
	...
	"量" => "amount",
	"确认订单" => "Confirm",
	    "今日交易量" => "Today's Trading Volume",
    "需交易量" => "Required Trading Volume",
	"订单类型" => "Order type",
	"到期时间" => "expire",
	"收益率" => "Yield",
...
",
    ...
    'Bitwise一直以来担任全球加密货币领导者' => 'Bitwise has long been a global cryptocurrency leader',
    '24小时交易量' => '24 hour trading volume',
    '立即开始您的加密货币之旅' => 'Start your cryptocurrency journey today',
    'Robit 全球公司拥有多种功能，使其成为买卖数字资产的理想场所' => 'Robit Global has several features that make it an ideal place to buy and sell digital assets',
    '管理您的资产' => 'Manage your assets',
    '以高达5倍的杠杆率进行现货交易' => 'Spot trading with up to 5x leverage',
    '信用卡付款' => 'credit card payment',
    '通过我们的合作伙伴用您的信用卡购买加密货币' => 'Buy cryptocurrency with your credit card through our partners',
    '安全储存' => 'safe storage',
    '客户资金存放在专用的多签名' => 'Client funds are held in a dedicated multi-signature',
    '冷钱包中.24/7全天候安全监控' => 'in a cold wallet. 24/7 security monitoring',
    '专用20,000 BTC安全储备金' => 'Dedicated 20,000 BTC safety reserve',
    '随处访问' => 'access anywhere',
    '在我们用于Android和iOS的移动应用上进行24/7全' => '24/7 access to our mobile apps for Android and iOS',
    '天候存款，取款和交易' => 'Weather deposits, withdrawals and transactions',
    '公告' => 'Bulletin',

    '购买加密货币' => "Buy Cryptocurrency",

    '涨幅' => 'Gain',
    '24小时量' => '24 Hours',

    '当前委托' => 'Current Mandate',
    '历史委托' => 'Historical Commission',
    '关于我们' => 'About Us',
    'MSB证书' => 'MSB Certificate',
    '隐私政策申明' => 'Privacy Policy Statement',
    '服务条款' => 'Terms of Service',
    '新币特价抢先购' => 'SGD Specials Early Access',
    '为用户提供低成本抢首发项目的投资机会' => 'Provide users with low-cost investment opportunities to grab first-time projects',
    '即享挖矿奖励，随存随取，灵活操作' => 'Instantly enjoy mining rewards, deposit and withdraw anytime, and operate flexibly',
    ...
    '我要买币' => 'Buy Crypto',
    '秒合约记录' => 'Second contract record',
    '选择周期' => 'Selection Period',
    '选择金额' => 'Select Amount',
    '预计盈利' => 'Expected',
    '请输入出售数量' => 'Please enter the quantity to sell',

    '即享挖矿奖励' => 'Instant mining rewards',
    '随存随取' => 'Store as you go',
    '灵活操作' => 'Flexible operation',
    '提现密码' => 'Withdrawal Password',
    '买入量' => 'Buy Volume',
    '邮箱reg' => 'E-mail',
    '手机' => 'Mobile',
    '请完成安全验证' => 'Please complete security verification',
    '向右滑动填充拼图' => 'Swipe right to fill puzzle',
    ...
    '邮箱不一致' => 'Mailbox inconsistency',
    '发送成功' => 'Sending succeeded',
    '发送失败' => 'fail in send',
    // '验证码错误' => 'Verification Code Error',
    // '验证码错误' => 'Verification Code Error',
    
    '请输入名字' => 'Please enter your namer',
    '请输入账号' => 'Please enter account',
    '账号' => 'Account',
    '重复密码不正确' => 'Incorrect duplicate password',
    '认证类型' => 'Authentication Type',

    '上传证件正面' => 'Upload the front of the document',
    '上传证件反面' => 'Upload the back of the document',
    ...
    '请填写地区' => 'Please fill in the region',
    '请填写真实姓名' => 'Please fill in your real name',
    '请选择认证类型' => 'Please select an authentication type',
    '审核中' => 'Under Review',
    '已设置' => 'Already set',
    '未设置' => 'Not set yet',
    '密码设置' => 'Password Setting',
    '如忘记旧密码无法修改提现密码，请第一时间联系在线客服核实身份后修改' => 'If you forget the old password and cannot change the withdrawal password, please contact the online customer service for the first time to verify your identity and then modify it',

    '正在加载中' => 'Loading',
    '再试一次' => 'Try again',

'欧易数字货币交易所更快、更好、更强' => 'OKX digital currency exchange is faster, better and stronger',
    '邮箱/手机号' => 'Email/Mobile Number',
    '立即体验' => 'experience now',
    '数字货币交易，我们是专业的' => 'Digital currency trading, we are professional',
    '最低的手续费，最快捷的交易，强劲的 API 以及更多' => 'Lowest fees, fastest transactions, robust API and more',
    '欧易App，创造无限可能' => 'OKX App, creating infinite possibilities',
    '精简版' => 'Lite',
    'Web3' => 'Web3',
    '专业版' => 'Professional Edition',
    '初次交易？$5即可小试牛刀，欧易和您一起步步登高' => 'First transaction? You can try your hand at $5, and OKX will climb up with you step by step',
    '探索全球一流的 NFT 交易市场、DEX 以及多链钱包。' => 'Explore the worlds first-class NFT trading market, DEX and multi-chain wallet.',
    '保证金模式和合约交易、强大的 API 以及策略交易，使您堪比专业交易者。' => 'Margin mode and contract trading, powerful API and strategic trading make you comparable to professional traders.',
    '您数字货币之旅的得力助手' => 'Your Right-hand Assistant on Your Digital Currency Journey',
    '从数字货币交易初体验到第一次购买 NFT，欧易将助您轻松赚币' => 'From the initial experience of digital currency trading to the first purchase of NFT, OKX will help you earn coins easily',
    '从交易到 Defi，及 NFT，欧易将助您轻松赚币' => 'From trading to Defi, and NFT, OKX will help you earn coins easily',
    '走近欧易' => 'Approach OKX',
    '在我们世界级合作伙伴的帮助下，了解为什么欧易会是你最喜爱的数字货币交易App。' => 'With the help of our world-class partners, find out why OKX is your favorite digital currency trading app.',
    '发现更多' => 'discover more',
    '何塞普·瓜迪奥拉教练' => 'Coach Josep Guardiola',
    '讲解“疯狂足球战术”' => 'Explaining "Crazy Football Tactics"',
    'F1赛车手丹尼尔·里卡多' => 'F1 driver Daniel Ricciardo',
    'OKX是否是赛车' => 'Is OKX a racing car',
    '单板滑雪运动员斯科特·詹姆斯' => 'snowboarder scott james',
    '常见问题' => 'common problem',
    '欧易都提供哪些产品' => 'What products does OKX provide',
    '如何通过欧易平台购买比特币？' => 'How to buy bitcoin through OKX platform?',
    '欧易总部设在哪里？' => 'Where is OKX headquartered?',
    '美国公民可以使用欧易吗？' => 'Can U.S. citizens use OKX?',
    '您的提币功能已被禁止，请联系客服' => 'Your withdrawal function has been disabled, please contact customer service',
    '我的' => 'site',
    '验证码5分钟有效，请稍后再试' =>'The verification code is valid for 5 minutes, please try again later',
    
    // 登录页面相关翻译
    '欢迎来到数字未来世界' => 'Welcome to the Digital Future World',
    '请输入用户名/账号' => 'Please enter username/account',
    '立即开户' => 'Open Account Now',
    '忘记密码' => 'Forgot Password',
    '请输入账号' => 'Please enter account',

'/Public/Home/static/img/61D57025B5E4454A.mp4' =>'/Public/Static/img/7A3CB59773E00032.mp4',
'/Public/Home/static/img/AC0E01D5AA8F7F01.mp4' =>'/Public/Static/img/3CFACBA4274C2F0B.mp4',
'/Public/Home/static/img/D98EEDEC0A2423FF.jpg' =>'/Public/Static/img/07ECF45599A515CA.jpg',
'/Public/Home/static/img/897D66D0C2FFDB72.jpg' =>'/Public/Static/img/04DC9DE07AF5E0EE.jpg',
'/Public/Home/static/img/9C49E308610CC783.jpg' =>'/Public/Static/img/F03C76496545D788.jpg',
'/Public/Home/static/img/CE0AD2E6133080DF.png' =>'/Public/Static/img/DBDC29AD98D75479.png',
              '发布时间' =>'Time',
    ...
    "推广分享海报" => "Promotion Poster",
    "更多设置" => "More Settings",
    "平台公告" => "Platform Announcements",
    "退出登录" => "Logout",
    "记录" => "Records",
    "请选择充值方式" => "Please select deposit method",
    "请填写充值金额" => "Please enter deposit amount",
    ...
    "请输入提现密码" => "Please enter withdrawal password",
    "提现金额必须大于11" => "Withdrawal amount must be greater than 11",
    "提现金额必须小于300000" => "Withdrawal amount must be less than 300000",
    "修改登录密码" => "Change Login Password",
    "更换语言" => "Change Language",
    "我的邀请码" => "My Invitation Code",
    "为保证资金安全，如需修改请联系在线客服" => "For account security, please contact customer service for modifications",
