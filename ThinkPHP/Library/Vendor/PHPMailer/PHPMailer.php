...
class PHPMailer
{
    ...
    public function preSend()
    {
        ...
        /*var_dump(ini_get('mail.add_x_header'),(version_compare(PHP_VERSION, '7.0.0', '>=') and version_compare(PHP_VERSION, '7.0.17', '<')),(version_compare(PHP_VERSION, '7.1.0', '>=')
